  ...
  return (
    <section id="home" className="hero-section text-white text-center" style={{ paddingTop: "80px", minHeight: "65vh", display: "flex", alignItems: "center" }}>
      <div className="container position-relative" style={{ zIndex: 2, maxWidth: "1200px", padding: "20px" }}>
        <h1 className="display-4 mb-4 fw-bold" style={{ fontSize: "clamp(26px, 4vw, 52px)" }}>Transport & Logistics Services</h1>
        <p className="lead mb-5" style={{ fontSize: "clamp(14px, 2.5vw, 20px)", lineHeight: "1.6" }}>Your Trusted Partner in Logistics Solutions</p>
